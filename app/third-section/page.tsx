    ...
    <div className="flex p-10 flex-col md:flex-row md:justify-evenly">
      <div className="flex-col md:flex-row gap-6 md:px-10 flex">
        ...
        <div className="flex-col border p-4 rounded-xl md:w-2/5">
          <div className="text-4xl flex text-center justify-center text-center md:text-6xl bg-gradient-to-r from-yellow-300 to-blue-300 bg-clip-text text-transparent">
            Fully managable ecommerce platform
          </div>
